...
return [
    ...
    */
    ...
    |
    | Laravel supports a variety of "mail driver" drivers to be used while
    ...
    */
    ...
    'mailers' => [
        ...
        'smtp' => [
            ...
            'port' => env('MAIL_PORT') !== null ? (int) env('MAIL_PORT') : 587,
    ...
    */
    ...
    | of the emails. Or, you may simply use the Laravel default!
    |
    */
