...
<div class="max-w-4xl">
    ...
    <form id="kb-form" method="POST" action="{{ route('admin.knowledge.store') }}" enctype="multipart/form-data" class="space-y-5" x-data="{ categoryVal: @js(old('category', '')) }">
        ...
        <div class="section-card p-6 space-y-4">
            <h3 class="text-xs font-black text-slate-500 uppercase tracking-widest flex items-center gap-2">
                <i class="fa-solid fa-paperclip text-indigo-500"></i> File Attachment <span class="text-[9px] font-medium text-slate-300 normal-case tracking-normal">Optional</span>
            </h3>
            ...
            <label for="file-upload" class="flex justify-center px-6 pt-5 pb-6 border-2 border-slate-200 border-dashed rounded-2xl bg-slate-50/60 hover:bg-indigo-50/30 hover:border-indigo-300 transition-all cursor-pointer group">
                <div class="space-y-2 text-center">
                    ...
                    <div class="text-xs text-slate-600">
                        <span class="font-bold text-indigo-600">Click to upload a file</span> or drag and drop
        ...
        <div class="flex justify-between items-center pt-2">
            ...
            <button type="submit" id="submit-btn"
                class="px-6 py-2.5 rounded-xl bg-indigo-600 text-white text-sm font-bold hover:bg-indigo-700 active:scale-95 transition-all shadow-md shadow-indigo-600/20 flex items-center gap-2">
