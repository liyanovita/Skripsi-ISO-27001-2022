...
@section('header_title', 'Add Organization')
...
<div class="max-w-2xl">
    ...
    <a href="{{ route('admin.organizations.index') }}"
        ...
        <i class="fa-solid fa-arrow-left group-hover:-translate-x-1 transition-transform"></i> Back to Organizations
    </a>
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h2 class="text-lg font-black text-slate-800">New Organization</h2>
            <p class="text-xs text-slate-400 font-medium">Register a client organization for ISO 27001:2022 audits</p>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('admin.organizations.store') }}" class="space-y-5">
        ...
        <div class="section-card p-6 space-y-5">
            <h3 class="text-xs font-black text-slate-500 uppercase tracking-widest flex items-center gap-2">
                <i class="fa-solid fa-id-card text-blue-400"></i> Basic Information
            </h3>
                ...
                <div class="field-group">
                    ...
                    <select name="business_sector" class="form-input w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm">
                        ...
                        @foreach(\App\Models\Organization::getBusinessSectors() as $sector)
                            <option value="{{ $sector }}" {{ old('business_sector') == $sector ? 'selected' : '' }}>{{ $sector }}</option>
                        @endforeach
                    </select>
            ...
            <div class="field-group">
                ...
                <textarea name="address" rows="2"
                    ...
                    class="form-input w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm resize-none">{{ old('address') }}</textarea>
        ...
        <div class="section-card p-6 space-y-5">
            ...
            <div class="field-group">
                ...
                <textarea name="it_governance_structure" rows="3"
                    ...
                    class="form-input w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm resize-none">{{ old('it_governance_structure') }}</textarea>
            ...
            <div class="field-group">
                ...
                <textarea name="isms_scope" rows="3"
                    ...
                    class="form-input w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm resize-none">{{ old('isms_scope') }}</textarea>
        ...
        <div class="flex justify-end gap-3">
            ...
            <button type="submit"
                ...
                <i class="fa-solid fa-plus text-xs"></i> Add Organization
            </button>
        </div>
    </form>
</div>
