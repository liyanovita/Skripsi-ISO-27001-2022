...
<div class="max-w-3xl">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <div class="p-5 border-b border-slate-100 flex items-center gap-3">
            ...
            <div>
                <h3 class="font-bold text-slate-800">Launch New Audit Session</h3>
                <p class="text-[11px] text-slate-400 font-medium mt-0.5">Configure session details and assign auditors</p>
            </div>
        </div>

        <form method="POST" action="{{ route('admin.sessions.store') }}" class="p-6 space-y-6" x-data="{ search: '' }">
            @csrf
                    ...
                    <div>
                        ...
                        @if($organizations->isEmpty())
                            <p class="text-[11px] text-slate-400 mt-1 flex items-center gap-1">
                                ...
                                <a href="{{ route('admin.organizations.create') }}" class="text-blue-500 hover:underline font-bold">Register one?</a>
                            </p>
                        @endif
            ...
            <div>
                ...
                <p class="text-[11px] text-slate-400 mt-1"><i class="fa-solid fa-circle-info text-slate-400 mr-0.5"></i>Setting to Draft makes it visible only to administrators for preparation.</p>
            ...
            {{-- Section 4: Additional Auditors (multi-select) --}}
            <div x-data="{ search: '' }">
            ...
            <div class="pt-4 border-t border-slate-100 flex justify-end gap-3">
                ...
                <button type="submit" class="px-5 py-2.5 rounded-lg bg-blue-600 text-white text-sm font-bold hover:bg-blue-700 transition-colors shadow-sm flex items-center gap-2">
                    <i class="fa-solid fa-rocket text-xs"></i> Launch Session
                </button>
            </div>
        </form>
    </div>
