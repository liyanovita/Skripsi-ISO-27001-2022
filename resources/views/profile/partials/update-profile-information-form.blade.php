<section>
    <header class="mb-5">
        <h2 class="text-sm font-black text-slate-900 tracking-tight uppercase">{{ __('Profile Information') }}</h2>
        <p class="mt-0.5 text-[9px] font-bold text-slate-400 uppercase tracking-widest">{{ __('Update your organization details and contact settings.') }}</p>
    </header>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-slate-50/50 rounded-2xl border border-slate-100 relative overflow-hidden">
            ...
            <div class="space-y-1.5">
                ...
                <select id="organization_scale" name="organization_scale" 
                    x-data="{ selected: '{{ old('organization_scale', $user->organization_scale) }}' }"
                    x-model="selected"
                    ...
                    <option value="Small" class="text-slate-800" {{ old('organization_scale', $user->organization_scale) == 'Small' ? 'selected' : '' }}>{{ __('Small (1-50 Employees)') }}</option>
                    <option value="Medium" class="text-slate-800" {{ old('organization_scale', $user->organization_scale) == 'Medium' ? 'selected' : '' }}>{{ __('Medium (51-250 Employees)') }}</option>
                    <option value="Large" class="text-slate-800" {{ old('organization_scale', $user->organization_scale) == 'Large' ? 'selected' : '' }}>Large (>250 Employees)</option>
                </select>
